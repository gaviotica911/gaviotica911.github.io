const socialLinks = [
  {
    href: "https://github.com/gaviotica911",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.linkedin.com/in/gabriela-garcia-suarez/",
    icon: (
      <svg
        width="24"
        height="24"
      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="headline-2 lg:max-w-[12ch] reveal-up">
            Feel free to connect with me to explore collaboration opportunities.
          </h2>

          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
            Let&apos;s discuss your project ideas and create something
        ...
        <form
          action="https://getform.io/f/ajjjgoja"
          method="POST"
            ...
            <div className="mb-4">
              <div className="">
                ...
                <input
                  ...
                  autoComplete="email"
                  className="text-field reveal-up"
                  placeholder="gabriela@example.com"
                  required
                />
              </div>
            </div>
